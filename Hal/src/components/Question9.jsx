...
function Questions() {
  ...
  <div className="p-1 items-center">
    ...
    <div className="grid gap-4 p-6">
      ...
      <Link to={`/user/chat10?data=${send}`}  className="bg-indigo-600 text-white p-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90">
        Submit
      </Link >
    </div>
  </div>
